...
public class Model {
    ...
    /**
     * Get pool of all spells
     *
     * @return list of all spells given by config
     */
    ...
    /**
     * Get all available drawn spells
     *
     * @return list  of all drawn spells
     */
    public final List<Spell> getAvailableSpells() {
    ...
    /**
     * Draw a spell from stack and add it to list of available spells
     *
