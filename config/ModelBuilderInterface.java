...
public interface ModelBuilderInterface<M> {
    ...
    String CFG_MAGIC_POINTS = "magicPoints";
    ...
    String CFG_STRUCTURE_EFFECT = "structureEffect";
    String CFG_BID_TYPE_BLOCKED = "bidTypeBlocked";
    ...
    void checkResourceSpell(DataChecker dataChecker);

    void checkBuffSpell(DataChecker dataChecker);

    void checkRoomSpell(DataChecker dataChecker);

    void checkBiddingSpell(DataChecker dataChecker);

    void checkStructureSpell(DataChecker dataChecker);

    /*void addSpell(int id, String spellType, String bidType, int slot, int food, int gold);

    void addSpell(int id, String spellType, String bidType, int slot, int healthPoints,
                  int healValue, int defuseValue);

    void addSpell(int id, String spellType, String bidType, int slot, String structureOrBid);

    void addSpell(int id, String spellType, String bidType, int slot);*/
