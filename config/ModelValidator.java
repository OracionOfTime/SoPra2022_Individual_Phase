...
public class ModelValidator<M> implements ModelBuilderInterface<M> {
    ...
    public void addAdventurer(final int id, final int difficulty, final int healthPoints,
        ...
        checkBounds("Adventurer" + ModelBuilderInterface.CFG_MAGIC_POINTS, 0, 3, magicPoints);
        this.adventurerIds.add(id);
        this.builder.addAdventurer(id, difficulty, healthPoints,
    ...
    public void checkResourceSpell(final DataChecker dataChecker) {
        checkUniqueId("Spell", this.spellIds, dataChecker.getId());
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_ID, dataChecker.getId());
        checkBounds("Spell" + ModelBuilderInterface.CFG_SPELL_SLOT, 1,
                3, dataChecker.getSlot());
        dataChecker.checkResource();
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_SPELL_FOOD, dataChecker.getFood());
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_SPELL_GOLD, dataChecker.getGold());
        this.spellIds.add(dataChecker.getId());
        this.builder.checkResourceSpell(dataChecker);
    }
    ...
    public void checkBuffSpell(final DataChecker dataChecker) {
        ...
        checkBounds("Spell" + ModelBuilderInterface.CFG_SPELL_SLOT, 1,
                3, dataChecker.getSlot());
        dataChecker.checkBuff();
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_SPELL_HEALTH_POINTS,
                dataChecker.getHealthPoints());
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_SPELL_HEAL_VALUE,
                dataChecker.getHealValue());
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_SPELL_DEFUSE_VALUE,
                dataChecker.getDefuseValue());
        this.spellIds.add(dataChecker.getId());
        this.builder.checkBuffSpell(dataChecker);
    }
    ...
    public void checkRoomSpell(final DataChecker dataChecker) {
        ...
        checkBounds("Spell" + ModelBuilderInterface.CFG_SPELL_SLOT, 1,
                3, dataChecker.getSlot());
        dataChecker.checkRoom();
        this.spellIds.add(dataChecker.getId());
        this.builder.checkRoomSpell(dataChecker);
    }
    ...
    public void checkBiddingSpell(final DataChecker dataChecker) {
        ...
        checkBounds("Spell" + ModelBuilderInterface.CFG_SPELL_SLOT, 1,
                3, dataChecker.getSlot());
        dataChecker.checkBidding();
        this.spellIds.add(dataChecker.getId());
        this.builder.checkBiddingSpell(dataChecker);
    }
    ...
    public void checkStructureSpell(final DataChecker dataChecker) {
        ...
        checkBounds("Spell" + ModelBuilderInterface.CFG_SPELL_SLOT, 1,
                3, dataChecker.getSlot());
        dataChecker.checkStructure();
        this.spellIds.add(dataChecker.getId());
        this.builder.checkStructureSpell(dataChecker);
    }
    /* @Override
    public void addSpell(final int id, final String spellType, final String bidType,
        ...
        checkBounds("Spell" + ModelBuilderInterface.CFG_SPELL_SLOT, 1, 3, slot);
        if (food == 0 && gold == 0) {
            throw new IllegalArgumentException();
        }
        ...
        this.builder.addSpell(id, spellType, bidType, slot, food, gold);
    }*/

    /*@Override
    public void addSpell(final int id, final String spellType, final String bidType, final int slot,
                         final int healthPoints, final int healValue, final int defuseValue) {
        checkUniqueId("Spell", this.spellIds, id);
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_ID, id);
        checkBounds("Spell" + ModelBuilderInterface.CFG_SPELL_SLOT, 1, 3, slot);
        if (healthPoints == 0 && healValue == 0 && defuseValue == 0) {
            throw new IllegalArgumentException();
        }
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_SPELL_HEALTH_POINTS, healthPoints);
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_SPELL_HEAL_VALUE, healValue);
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_SPELL_DEFUSE_VALUE, defuseValue);
        this.spellIds.add(id);
        this.builder.addSpell(id, spellType, bidType, slot, healthPoints, healValue, defuseValue);
    }*/

    /*@Override
    public void addSpell(final int id, final String spellType,
                         final String bidType, final int slot) {
        checkUniqueId("Spell", this.spellIds, id);
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_ID, id);
        checkBounds("Spell" + ModelBuilderInterface.CFG_SPELL_SLOT, 1, 3, slot);
        this.spellIds.add(id);
        this.builder.addSpell(id, spellType, bidType, slot);
    }

    @Override
    public void addSpell(final int id, final String spellType, final String bidType, final int slot,
                         final String bidOrStructure) {
        checkUniqueId("Spell", this.spellIds, id);
        checkPositiveZero("Spell" + ModelBuilderInterface.CFG_ID, id);
        checkBounds("Spell" + ModelBuilderInterface.CFG_SPELL_SLOT, 1, 3, slot);
        this.spellIds.add(id);
        this.builder.addSpell(id, spellType, bidType, slot, bidOrStructure);
    }*/
